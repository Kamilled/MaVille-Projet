...
public class Main {
    ...
    private static void modifierStatutProjet() {
        ...
        projet.setStatutPrevu(nouveauStatut); // Mise à jour du statut du projet
        ...
        String notificationMessage = "Le projet " + projet.getTitreProjet() + " a été mis à jour.\n" +
                "Nouveau Statut: " + projet.getStatutPrevu() + "\n" + projectDetails;
    ...
    private static void creerRequeteTravail() {
        ...
        try {
            ...
            if (status == 201) {
                ...
                System.out.println(
                        "Erreur lors de la création de la requête. Code HTTP : " + status
                );
            }
            ...
            System.out.println("Erreur de protocole : " + e.getMessage());
